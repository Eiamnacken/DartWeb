...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
  ...
  }], ["brickGame", "package:DartWeb/BrickGame.dart",, G, {
    "^": "",
    getValuesForDirection: function(direction) {
      var x, y;
      switch (direction) {
        case C.Direction_5:
          x = 0;
      ...
      return P.LinkedHashMap__makeLiteral(["X", x, "Y", y === 0 ? 0 : y * -1]);
    },
    getHealth: function(damage, health) {
      var index = health.index - damage;
      if (index <= 0)
        return C.Health_0;
      else {
        if (index >= 5)
          return H.ioore(C.List_MUs, index);
        return C.List_MUs[index];
      }
    },
    generateHealth: function(health) {
      var buffer;
      if (health === "green")
        buffer = C.Health_3;
      else if (health === "grey")
        ...
        buffer = health === "brown" ? C.Health_4 : null;
      return buffer;
    },
    GameController: {
      "^": "Object;game,view,_ballTrigger",
      updateView$1: function(gameField) {
        var t1, t2, t3;
        t1 = this.game;
        t2 = t1.gameFields;
        t3 = t1.countLevel;
        ...
        t2[t3]._gameField = gameField;
        this.view.update$1(t1);
      },
      GameController$0: function() {
        var t1 = J.get$onClick$x(document.querySelector("#start"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector("#rightbutton"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure0(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector("#leftbutton"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure1(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keyup", false), [null]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure2(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        this.view.generateField$1(this.game);
      },
      static: {
        GameController$: function() {
          var t1 = new G.GameController(G.Game$(), new G.View(document.querySelector("#warningoverlay"), document.querySelector("#title"), document.querySelector("#level"), document.querySelector("#gameover"), document.querySelector("#game"), document.querySelector("#points"), document.querySelector("#highscore"), document.querySelector("#welcome"), document.querySelector("#overlay"), null), null);
          t1.GameController$0();
          return t1;
        }
      }
    },
    GameController_closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1, t2;
        t1 = this.$this;
        ...
        if (t2 != null)
          t2.cancel$0();
        if (t1.game.won$0() || t1.game.gameOver$0())
          t1.game = G.Game$();
        t1._ballTrigger = P.Timer_Timer$periodic(C.Duration_100000, new G.GameController__closure(t1));
        t1.view.generateField$1(t1.game);
      }
    },
    GameController__closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this;
        return t1.game.moveBall$1(t1);
      }
    },
    GameController_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this;
        if (t1.game.gameOver$0())
          return;
        t1.game.movePLayer$2(C.Direction_7, t1);
      }
    },
    GameController_closure1: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this;
        if (t1.game.gameOver$0())
          return;
        t1.game.movePLayer$2(C.Direction_6, t1);
      }
    },
    GameController_closure2: {
      "^": "Closure:0;$this",
      call$1: function($event) {
        var t1 = this.$this;
        if (t1.game.gameOver$0())
          return;
        if (J.get$keyCode$x($event) === 37)
          t1.game.movePLayer$2(C.Direction_6, t1);
    ...
    Ball: {
      "^": "MoveableObject;_damage,_moveSpeed,_direction,xPosition,yPosition,width,height,itemsBuffer",
      get$direction: function(_) {
        return this._direction;
      },
      collision$2: function(gameField, collisionObject) {
        var t1, playerPieces, t2, playerMiddle, ballPosition;
        if (collisionObject instanceof G.Player) {
          t1 = collisionObject.width;
          if (typeof t1 !== "number")
            return t1.$div();
          playerPieces = C.JSDouble_methods.round$0(t1 / 3);
          t1 = collisionObject.xPosition;
          t2 = this.width;
          if (typeof t2 !== "number")
            return H.iae(t2);
          playerMiddle = t1 * t2 + 1;
          ballPosition = this.xPosition * t2;
          if (ballPosition >= playerMiddle && ballPosition <= playerMiddle + playerPieces)
            this._direction = C.Direction_4;
          else if (ballPosition >= playerMiddle - playerPieces && ballPosition <= playerMiddle)
            this._direction = C.Direction_0;
          else
            this._direction = C.Direction_2;
        } else if (collisionObject == null) {
          t1 = this._direction;
          if (t1 === C.Direction_4)
            this._direction = C.Direction_5;
          else if (t1 === C.Direction_0) {
            if (this.xPosition === 0)
              this._direction = C.Direction_2;
            if (this.yPosition === 0)
              this._direction = C.Direction_1;
          } else if (t1 === C.Direction_2) {
            if (this.xPosition === gameField.length - 1)
              this._direction = C.Direction_0;
            if (this.yPosition === 0)
              this._direction = C.Direction_3;
          } else if (t1 === C.Direction_1)
            this._direction = C.Direction_3;
          else if (t1 === C.Direction_3)
            this._direction = C.Direction_1;
        } else
          this._direction = collisionObject.getCollison$1(this);
      },
      move$3: function(direction, gameField, controller) {
        var t1, t2, t3, coordinates, response, brickBuffer;
        t1 = this.yPosition;
        if (0 >= gameField.length)
          return H.ioore(gameField, 0);
        if (t1 === J.$sub$n(J.get$length$asx(gameField[0]), 1)) {
          t1 = this.xPosition;
          if (t1 >= gameField.length)
            return H.ioore(gameField, t1);
          t2 = gameField[t1];
          t3 = this.yPosition;
          t1 = new G.Field(t1, t3, this.width, this.height, null);
          t1.itemsBuffer = [];
          J.$indexSet$ax(t2, t3, t1);
          controller.updateView$1(gameField);
        }
        coordinates = G.getValuesForDirection(direction);
        response = this.collisionAhead$4(direction, gameField, coordinates.$index(0, "Y"), coordinates.$index(0, "X"));
        t1 = response.get$keys();
        if (t1.get$first(t1) !== true) {
          t1 = response.get$values(response);
          this.switchObjects$3(gameField, this, t1.get$first(t1));
          controller.updateView$1(gameField);
        } else {
          this.collision$2(gameField, response.$index(0, true));
          if (response.$index(0, true) != null) {
            response.$index(0, true).collision$2(gameField, this);
            if (response.$index(0, true) instanceof G.Brick) {
              brickBuffer = response.$index(0, true);
              controller.game.increasePoints$1(brickBuffer.get$health());
            }
          }
          this.move$3(this._direction, gameField, controller);
        }
      },
      toString$0: function(_) {
        return "ball";
    ...
    Brick: {
      "^": "GameObject;_containsItem,health<,xPosition,yPosition,width,height,itemsBuffer",
      collision$2: function(gameField, collisionObject) {
        var t1, t2, t3;
        if (!!collisionObject.$isBall) {
          t1 = G.getHealth(collisionObject._damage, this.health);
          this.health = t1;
          if (t1 === C.Health_0) {
            t1 = this.xPosition;
            if (t1 >= gameField.length)
    ...
    Direction: {
      "^": "Object;index",
      toString$0: function(_) {
        return C.Map_2VqNA.$index(0, this.index);
      }
    },
    Health: {
      "^": "Object;index",
      toString$0: function(_) {
        return C.Map_yTAyI.$index(0, this.index);
      }
    },
    Field: {
      "^": "GameObject;xPosition,yPosition,width,height,itemsBuffer",
      collision$2: function(gameField, collisionObject) {
        return;
      },
      toString$0: function(_) {
    ...
    Game: {
      "^": "Object;_incLength,_decLength,_decSpeedPLayer,_incDamageBall,countLevel,points,gameFields",
      moveBall$1: function(controller) {
        var t1, t2, balls;
        t1 = this.gameFields;
        t2 = this.countLevel;
        if (t2 >= t1.length)
        ...
        balls = t1[t2].balls;
        if (balls.length !== 0)
          C.JSArray_methods.forEach$1(balls, new G.Game_moveBall_closure(this, controller));
      },
      movePLayer$2: function(direction, controller) {
        var t1, t2, player, i, t3;
        t1 = this.gameFields;
        t2 = this.countLevel;
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        player = t1[t2]._player;
        if (!this.gameOver$0())
          for (i = player._moveSpeed; t1 = J.getInterceptor$n(i), t1.$gt(i, 0); i = t1.$sub(i, 1)) {
            t2 = this.gameFields;
            t3 = this.countLevel;
            if (t3 >= t2.length)
              return H.ioore(t2, t3);
            player.move$3(direction, t2[t3]._gameField, controller);
          }
      },
      gameOver$0: function() {
        var t1, t2;
      ...
      won$0: function() {
        ...
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        t2 = t1[t2];
        if (t2.bricks.length === 0 && t2.balls.length > 0)
          return true;
        return false;
      },
      increasePoints$1: function(health) {
        var t1, t2;
        if (health === C.Health_0) {
          t1 = this.gameFields;
          t2 = this.countLevel;
          if (t2 >= t1.length)
            return H.ioore(t1, t2);
      ...
      _readConfig$0: function() {
        ...
        for (i = 0; i < levelsAsJson.length; ++i) {
          level = new G.Level(null, null, null, null, null, null, null, null, null);
          level.balls = [];
          level.items = [];
          level.bricks = [];
          level.readLevel$1(levelsAsJson[i]);
          this.gameFields.push(level);
        }
      },
      Game$0: function() {
        this.gameFields = [];
      ...
      static: {
        Game$: function() {
          var t1 = new G.Game(null, null, null, null, null, 0, null);
          t1.Game$0();
          return t1;
        }
      }
    },
    Game_moveBall_closure: {
      "^": "Closure:0;$this,controller",
      call$1: function(ball) {
        var t1, t2, t3, t4, t5;
        t1 = J.get$direction$x(ball);
        t2 = this.$this;
        t3 = t2.gameFields;
        t4 = t2.countLevel;
        if (t4 >= t3.length)
        ...
        t5 = this.controller;
        ball.move$3(t1, t3[t4]._gameField, t5);
        t1 = ball.yPosition;
        t3 = t2.gameFields;
        t4 = t2.countLevel;
        if (t4 >= t3.length)
        ...
        if (t1 === t4._player.yPosition) {
          ...
          if (t3 >= t1.length)
            return H.ioore(t1, t3);
          t5.updateView$1(t1[t3]._gameField);
        }
        if (t2.won$0())
          ++t2.countLevel;
      }
    ...
    GameObject: {
      "^": "Object;xPosition<,yPosition<,width>,height>",
      getCollison$1: function(object) {
        var differenceX, differenceY, t1, buffer;
        differenceX = this.xPosition - object.xPosition;
        differenceY = this.yPosition - object.yPosition;
        t1 = differenceX === 0;
        if (t1 && differenceY <= 0)
          buffer = C.Direction_5;
        else if (differenceX >= 0 && differenceY === 0) {
          t1 = object._direction;
          if (t1 === C.Direction_0)
            buffer = C.Direction_2;
          else if (t1 === C.Direction_2)
            buffer = C.Direction_0;
          else if (t1 === C.Direction_1)
            buffer = C.Direction_3;
          else
            buffer = t1 === C.Direction_3 ? C.Direction_1 : null;
        } else
          buffer = t1 && differenceY >= 0 ? C.Direction_4 : null;
        return buffer;
      }
    },
    MoveableObject: {
      ...
      collisionAhead$4: function(direction, gameField, y, x) {
        var buffer, e, player, playerPosition, response, xVert, yVert, t1, t2, t3, buffer0, exception, wallDifference, i, bufferPlayer;
        buffer = null;
        if (direction === C.Direction_3)
          response = G.getValuesForDirection(C.Direction_7);
        else if (direction === C.Direction_1)
          response = G.getValuesForDirection(C.Direction_6);
        else if (direction === C.Direction_0)
          response = G.getValuesForDirection(C.Direction_6);
        else
          response = direction === C.Direction_2 ? G.getValuesForDirection(C.Direction_7) : null;
        if (response != null) {
          xVert = response.$index(0, "X");
          yVert = response.$index(0, "Y");
          if (!this._isOutofMap$3(yVert, xVert, gameField)) {
            t1 = this.xPosition;
            if (typeof xVert !== "number")
              return H.iae(xVert);
            t1 = J.$index$asx(gameField, t1 + xVert);
            t2 = this.yPosition;
            if (typeof yVert !== "number")
              return H.iae(yVert);
            buffer = J.$index$asx(t1, t2 + yVert);
            if (buffer instanceof G.Field)
              buffer = null;
          }
        }
        if (!this._isOutofMap$3(y, x, gameField)) {
          try {
            if (buffer == null) {
              t1 = this.xPosition;
              t2 = x;
              if (typeof t2 !== "number")
                return H.iae(t2);
              t2 = J.$index$asx(gameField, t1 + t2);
              t1 = this.yPosition;
              t3 = y;
              if (typeof t3 !== "number")
                return H.iae(t3);
              buffer0 = J.$index$asx(t2, t1 + t3);
            } else
              buffer0 = buffer;
            buffer = buffer0;
          } catch (exception) {
          ...
          if (buffer instanceof G.Field) {
            t1 = this._direction;
            t1 = t1 === C.Direction_5 || t1 === C.Direction_3 || t1 === C.Direction_1;
          } else
            t1 = false;
          if (t1)
            if (buffer.get$yPosition() === J.$sub$n(J.get$length$asx(J.$index$asx(gameField, 0)), 1)) {
              t1 = this.xPosition;
              t2 = this.width;
              if (typeof t2 !== "number")
                return H.iae(t2);
              wallDifference = (t1 + 1) * t2;
              player = null;
              i = 0;
              while (true) {
                t1 = J.get$length$asx(gameField);
                if (typeof t1 !== "number")
                  return H.iae(t1);
                if (!(i < t1))
                  break;
                bufferPlayer = J.$index$asx(J.$index$asx(gameField, i), J.$sub$n(J.get$length$asx(J.$index$asx(gameField, i)), 1));
                if (bufferPlayer instanceof G.Player) {
                  player = bufferPlayer;
                  break;
                }
                ++i;
              ...
              playerPosition = null;
              try {
                t1 = player.get$xPosition();
                t2 = J.get$width$x(buffer);
                if (typeof t2 !== "number")
                  return H.iae(t2);
                t3 = J.get$width$x(player);
                if (typeof t3 !== "number")
                  return t3.$div();
                playerPosition = C.JSNumber_methods.round$0((t1 + 1) * t2 - t3 / 3);
              } catch (exception) {
                H.unwrapException(exception);
              }
              t1 = playerPosition;
              if (typeof t1 !== "number")
                return H.iae(t1);
              if (wallDifference >= t1) {
                t1 = J.$add$ns(playerPosition, J.get$width$x(player));
                if (typeof t1 !== "number")
                  return H.iae(t1);
                t1 = wallDifference <= t1;
              } else
                t1 = false;
              if (t1)
                buffer = player;
          ...
          return P.LinkedHashMap__makeLiteral([true, buffer]);
        if (buffer instanceof G.Field)
          return P.LinkedHashMap__makeLiteral([false, buffer]);
        if (!!this.$isPlayer && buffer instanceof G.Ball)
          return P.LinkedHashMap__makeLiteral([false, buffer]);
        return P.LinkedHashMap__makeLiteral([true, buffer]);
      },
      _isOutofMap$3: function(y, x, gameField) {
        var t1, t2, t3;
        t1 = this.xPosition;
        t2 = t1 + x;
        t3 = gameField.length;
        if (t2 < t3 && t2 >= 0) {
          ...
          if (t1 >= t3)
            return H.ioore(gameField, t1);
          t1 = J.get$length$asx(gameField[t1]);
          if (typeof t1 !== "number")
            return H.iae(t1);
          t1 = t2 + y < t1 && this.yPosition + y >= 0;
        } else
          t1 = false;
        if (t1)
          return false;
      ...
      switchObjects$3: function(gameField, object1, object2) {
        var x, y, t1;
        if (object2 == null)
          return;
        x = object1.xPosition;
        ...
        if (x >= gameField.length)
          return H.ioore(gameField, x);
        J.$indexSet$ax(gameField[x], y, object2);
        t1 = object2.get$xPosition();
        if (t1 >= gameField.length)
          return H.ioore(gameField, t1);
        J.$indexSet$ax(gameField[t1], object2.yPosition, object1);
    ...
    Level: {
      "^": "Object;_height,_brickGame$_length,_countPositiveItems,_countNegativeItems,_gameField,_player,balls,items,bricks",
      readLevel$1: function(config) {
        var jsonLevel, t1, playerHeight, playerLength, brickHeight, brickLength, ballHeight, ballLength, ballSpeed, playerSpeed, jsonField, row, t2, col, t3, brick, ball;
        jsonLevel = C.JsonCodec_null_null.decode$1(config);
        t1 = J.getInterceptor$asx(jsonLevel);
        this._height = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "levelHeight")), null, null);
        this._brickGame$_length = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "levelLength")), null, null);
        this._countPositiveItems = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "countPosItems")), null, null);
        this._countNegativeItems = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "countNegItems")), null, null);
        playerHeight = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "playerHeight")), null, null);
        playerLength = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "playerLength")), null, null);
        brickHeight = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "brickHeight")), null, null);
        brickLength = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "brickLength")), null, null);
        ballHeight = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "ballHeight")), null, null);
        ballLength = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "ballLength")), null, null);
        ballSpeed = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "ballSpeed")), null, null);
        playerSpeed = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "playerSpeed")), null, null);
        jsonField = t1.$index(jsonLevel, "levelField");
        this._gameField = P.Iterable_Iterable$generate(this._brickGame$_length, new G.Level_readLevel_closure(this), null).toList$0(0);
        t1 = J.getInterceptor$asx(jsonField);
        row = 0;
        while (true) {
          t2 = t1.get$length(jsonField);
          if (typeof t2 !== "number")
            return H.iae(t2);
          if (!(row < t2))
            break;
          col = 0;
          while (true) {
            t2 = J.get$length$asx(t1.$index(jsonField, row));
            if (typeof t2 !== "number")
              return H.iae(t2);
            if (!(col < t2))
              break;
            if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "empty") === 0) {
              t2 = this._gameField;
              if (col >= t2.length)
                return H.ioore(t2, col);
              t2 = t2[col];
              t3 = new G.Field(col, row, brickLength, brickHeight, null);
              t3.itemsBuffer = [];
              J.$indexSet$ax(t2, row, t3);
            } else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "redbrick") === 0) {
              brick = new G.Brick(null, null, col, row, brickHeight, brickLength, null);
              brick.itemsBuffer = [];
              brick.health = G.generateHealth("red");
              t2 = this._gameField;
              if (col >= t2.length)
                return H.ioore(t2, col);
              J.$indexSet$ax(t2[col], row, brick);
              this.bricks.push(brick);
            } else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "yellowbrick") === 0) {
              brick = new G.Brick(null, null, col, row, brickHeight, brickLength, null);
              brick.itemsBuffer = [];
              brick.health = G.generateHealth("yellow");
              t2 = this._gameField;
              if (col >= t2.length)
                return H.ioore(t2, col);
              J.$indexSet$ax(t2[col], row, brick);
            } else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "greenbrick") === 0) {
              brick = new G.Brick(null, null, col, row, brickHeight, brickLength, null);
              brick.itemsBuffer = [];
              brick.health = G.generateHealth("green");
              t2 = this._gameField;
              if (col >= t2.length)
                return H.ioore(t2, col);
              J.$indexSet$ax(t2[col], row, brick);
              this.bricks.push(brick);
            } else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "ball") === 0) {
              ball = new G.Ball(null, ballSpeed, C.Direction_5, col, row, ballHeight, ballLength, null);
              ball.itemsBuffer = [];
              ball._damage = 1;
              t2 = this._gameField;
              if (col >= t2.length)
                return H.ioore(t2, col);
              J.$indexSet$ax(t2[col], row, ball);
              this.balls.push(ball);
            } else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "player") === 0) {
              t2 = new G.Player(null, playerSpeed, null, col, row, playerLength, playerHeight, null);
              t2.itemsBuffer = [];
              this._player = t2;
              t3 = this._gameField;
              if (col >= t3.length)
                return H.ioore(t3, col);
              J.$indexSet$ax(t3[col], row, t2);
            }
            ++col;
          }
          ++row;
    ...
    Level_readLevel_closure: {
      "^": "Closure:0;$this",
      call$1: function(col) {
        return P.Iterable_Iterable$generate(this.$this._height, new G.Level_readLevel__closure(), null).toList$0(0);
      }
    },
    Level_readLevel__closure: {
      "^": "Closure:0;",
      call$1: function(row) {
        return;
      }
    ...
    Player: {
      "^": "MoveableObject;lastMove,_moveSpeed,_direction,xPosition,yPosition,width,height,itemsBuffer",
      move$3: function(direction, gameField, controller) {
        var t1, t2, t3, t4, playerLength, response;
        t1 = gameField.length;
        t2 = this.xPosition;
        if (t2 >= t1)
          return H.ioore(gameField, t2);
        t2 = J.get$width$x(J.$index$asx(gameField[t2], this.yPosition - 1));
        if (typeof t2 !== "number")
          return H.iae(t2);
        t3 = this.xPosition;
        if (t3 >= gameField.length)
          return H.ioore(gameField, t3);
        t4 = J.get$width$x(J.$index$asx(gameField[t3], this.yPosition - 1));
        if (typeof t4 !== "number")
          return H.iae(t4);
        playerLength = (1 + t3) * t4;
        if (direction === C.Direction_7)
          if (t1 * t2 - playerLength < C.JSNumber_methods.toInt$0(Math.floor(playerLength / 3)))
            return;
        response = this.collisionAhead$4(direction, gameField, 0, G.getValuesForDirection(direction).$index(0, "X"));
        t1 = response.get$keys();
        if (t1.get$first(t1) !== true) {
          if (response.$index(0, false) != null)
            response.$index(0, false).collision$2(gameField, this);
          t1 = response.get$values(response);
          this.switchObjects$3(gameField, this, t1.get$first(t1));
          controller.updateView$1(gameField);
        }
    ...
    View: {
      "^": "Object;warningoverlay,title,level,gameover,game,points,highscore,welcome,overlay,gameFields",
      generateField$1: function(model) {
        var t1, t2, field, table, row, col, assignment;
        t1 = model.gameFields;
        t2 = model.countLevel;
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        field = t1[t2]._gameField;
        table = "";
        row = 0;
        while (true) {
          if (0 >= field.length)
            return H.ioore(field, 0);
          t1 = J.get$length$asx(field[0]);
          if (typeof t1 !== "number")
            return H.iae(t1);
          if (!(row < t1))
            break;
          ...
          for (col = 0; col < field.length; ++col) {
            assignment = J.toString$0$(J.$index$asx(field[col], row));
            table += "<td id='" + ("field_" + col + "_" + row) + "' class='" + H.S(assignment) + "'  ></td>";
          }
          table += "</tr>";
          ++row;
        }
        t1 = this.game;
        J.set$innerHtml$x(t1, table);
        this.gameFields = H.setRuntimeTypeInfo(new Array(field.length), [[P.List, W.HtmlElement]]);
        for (row = 0; row < field.length; ++row) {
          ...
          while (true) {
            ...
            if (row >= t2.length)
              return H.ioore(t2, row);
            t2[row].push(t1.querySelector("#field_" + row + "_" + col));
            t2 = this.gameFields;
            if (row >= t2.length)
              return H.ioore(t2, row);
            t2 = t2[row];
            ...
            if (row >= field.length)
              return H.ioore(field, row);
            this._setWidthAndLength$2(t2, J.$index$asx(field[row], col));
            ++col;
          }
        }
      },
      update$2$scores: function(model, scores) {
        var t1, t2, field, row, col, td, object;
        t1 = model.gameOver$0() ? "Game Over" : "";
        J.set$innerHtml$x(this.gameover, t1);
        t1 = this.welcome.style;
        t2 = model.gameOver$0() ? "block" : "none";
        t1.display = t2;
        J.set$innerHtml$x(this.level, "Level: " + model.countLevel);
        t1 = model.gameOver$0() ? this.generateHighscore$1(scores) : "";
        J.set$innerHtml$x(this.highscore, t1);
        J.set$innerHtml$x(this.points, "Points: " + model.points);
        t1 = model.gameFields;
        t2 = model.countLevel;
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        ...
        for (row = 0; row < field.length; ++row) {
          ...
          while (true) {
            ...
            t1.get$classes(td).clear$0(0);
            if (row >= field.length)
              return H.ioore(field, row);
            object = J.$index$asx(field[row], col);
            t1.get$classes(td).add$1(0, J.toString$0$(object));
            this._setWidthAndLength$2(td, object);
            ++col;
          }
        }
      },
      update$1: function(model) {
        return this.update$2$scores(model, C.List_empty);
      },
      _setWidthAndLength$2: function(element, gameObject) {
        var t1, width, t2, t3, t4;
        if (element == null || gameObject == null)
          return;
        t1 = J.getInterceptor$x(gameObject);
        width = t1.get$width(gameObject);
        if (!!t1.$isPlayer) {
          t1 = gameObject.width;
          if (typeof t1 !== "number")
            return t1.$div();
          ...
          t1 = element.style;
          t2 = H.S(width) + "px";
          t3 = (t1 && C.CssStyleDeclaration_methods)._browserPropertyName$1(t1, "padding-right");
          t1.setProperty(t3, t2, "");
          t2 = H.S(width) + "px";
          t3 = C.CssStyleDeclaration_methods._browserPropertyName$1(t1, "padding-left");
          t1.setProperty(t3, t2, "");
          t2 = H.S(width) + "px";
          t3 = C.CssStyleDeclaration_methods._browserPropertyName$1(t1, "width");
          t1.setProperty(t3, t2, "");
          t2 = H.S(gameObject.height) + "px";
          t3 = C.CssStyleDeclaration_methods._browserPropertyName$1(t1, "height");
          t1.setProperty(t3, t2, "");
        } else {
          t2 = element.style;
          t3 = H.S(width) + "px";
          t4 = (t2 && C.CssStyleDeclaration_methods)._browserPropertyName$1(t2, "width");
          t2.setProperty(t4, t3, "");
          t1 = H.S(t1.get$height(gameObject)) + "px";
          t3 = C.CssStyleDeclaration_methods._browserPropertyName$1(t2, "height");
          t2.setProperty(t3, t1, "");
          t1 = C.CssStyleDeclaration_methods._browserPropertyName$1(t2, "padding-right");
          t2.setProperty(t1, "0px", "");
          t1 = C.CssStyleDeclaration_methods._browserPropertyName$1(t2, "padding-left");
          t2.setProperty(t1, "0px", "");
        }
      },
      generateHighscore$2$score: function(scores, score) {
        var list, points, t1;
        list = H.setRuntimeTypeInfo(new H.MappedListIterable(scores, new G.View_generateHighscore_closure()), [null, null]).join$1(0, "");
        points = "You got " + score + " points";
        t1 = "<div id='scorelist'>" + (score === 0 ? "" : points);
        return t1 + (list.length === 0 ? "" : "<ul>" + list + "</ul>") + "</div>";
      },
      generateHighscore$1: function(scores) {
        return this.generateHighscore$2$score(scores, 0);
      }
    },
    View_generateHighscore_closure: {
      "^": "Closure:0;",
      call$1: function(entry) {
        var t1 = J.getInterceptor$asx(entry);
        return "<li>" + H.S(t1.$index(entry, "name")) + ": " + H.S(t1.$index(entry, "score")) + "</li>";
      }
    }
  }], ["", "web/brickgameClient.dart",, X, {
    "^": "",
    main: [function() {
      return G.GameController$();
    }, "call$0", "brickgameClient__main$closure", 0, 0, 1]
    ...
    _GeneratorIterable: {
      "^": "Iterable;_start,_end,_generator",
      get$iterator: function(_) {
  ...
  C.Direction_0 = new G.Direction(0);
  C.Direction_1 = new G.Direction(1);
  C.Direction_2 = new G.Direction(2);
  C.Direction_3 = new G.Direction(3);
  C.Direction_4 = new G.Direction(4);
  C.Direction_5 = new G.Direction(5);
  C.Direction_6 = new G.Direction(6);
  C.Direction_7 = new G.Direction(7);
  C.Duration_0 = new P.Duration(0);
  C.Duration_100000 = new P.Duration(100000);
  C.Health_0 = new G.Health(0);
  C.Health_1 = new G.Health(1);
  C.Health_2 = new G.Health(2);
  C.Health_3 = new G.Health(3);
  C.Health_4 = new G.Health(4);
...
;
  ...
  C.List_MUs = Isolate.makeConstantList([C.Health_0, C.Health_1, C.Health_2, C.Health_3, C.Health_4]);
  ...
  C.Map_2VqNA = new H.GeneralConstantMap([0, "Direction.leftUp", 1, "Direction.leftDown", 2, "Direction.rightUp", 3, "Direction.rightDown", 4, "Direction.up", 5, "Direction.down", 6, "Direction.left", 7, "Direction.right"]);
  C.Map_yTAyI = new H.GeneralConstantMap([0, "Health.grey", 1, "Health.red", 2, "Health.yellow", 3, "Health.green", 4, "Health.brown"]);
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [W.Node, W.Node]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(X.brickgameClient__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(X.brickgameClient__main$closure(), a);
