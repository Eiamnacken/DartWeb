  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    GameController: {
      ...
      GameController$0: function() {
        ...
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new G.GameController_closure(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector("#leftbutton"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new G.GameController_closure0(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector("#rightbutton"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new G.GameController_closure1(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new G.GameController_closure2(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      static: {
        GameController$: function() {
          var t1 = new G.Game(null, null, null, null, null, null);
          t1.countLevel = 0;
          t1._readConfig$0();
          t1 = new G.GameController(t1, new G.View(document.querySelector("#warningoverlay"), document.querySelector("#title"), document.querySelector("#level"), document.querySelector("#gameover"), document.querySelector("#game"), document.querySelector("#overlay"), null), null);
          t1.GameController$0();
          return t1;
        }
      }
    ...
    GameController_closure: {
      ...
      call$1: function(_) {
        ...
        if (t2 != null)
          t2.cancel$0();
        t1._ballTrigger = P.Timer_Timer$periodic(C.Duration_250000, new G.GameController__closure(t1));
      }
    },
    ...
    GameController_closure0: {
      ...
      call$1: function(_) {
        ...
        if (t2.gameOver$0())
          return;
        t2.movePLayer$2(C.Direction_7, t1);
      }
    },
    GameController_closure1: {
      ...
      call$1: function(_) {
        ...
        if (t2.gameOver$0())
          return;
        t2.movePLayer$2(C.Direction_6, t1);
      }
    },
    ...
    Ball: {
      "^": "MoveableObject;_damage,_direction,moveSpeed,xPosition,yPosition,width,length"
    },
    Brick: {
      "^": "GameObject;_containsItem,_size,_xPosition,_yPosition,health,xPosition,yPosition,width,length"
    },
    Direction: {
      "^": "Object;index",
      toString$0: function(_) {
    ...
    Level: {
      "^": "Object;_height,_length,_countPositiveItems,_countNegativeItems,_gameField,player,balls,items,bricks",
      readLevel$1: function(config) {
        var jsonLevel, t1, playerHeight, playerLength, brickHeight, brickLength, ballHeight, ballLength, ballSpeed, playerSpeed, jsonField, t2, t3, row, t4, col, brick, ball, t5;
        ...
        this._length = H.Primitives_parseInt(J.toString$0$(t1.$index(jsonLevel, "levelLength")), null, null);
        ...
        this._gameField = P.Iterable_Iterable$generate(this._height, new G.Level_readLevel_closure(this), null).toList$0(0);
        t1 = J.getInterceptor$asx(jsonField);
        t2 = this.balls;
        t3 = this.bricks;
        row = 0;
        while (true) {
          t4 = t1.get$length(jsonField);
          if (typeof t4 !== "number")
            return H.iae(t4);
          if (!(row < t4))
            break;
          col = 0;
          while (true) {
            t4 = J.get$length$asx(t1.$index(jsonField, row));
            if (typeof t4 !== "number")
              return H.iae(t4);
            if (!(col < t4))
              break;
            if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "empty") === 0) {
              t4 = this._gameField;
              if (row >= t4.length)
                return H.ioore(t4, row);
              J.$indexSet$ax(t4[row], col, null);
            } else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "redbrick") === 0) {
              brick = new G.Brick(null, null, null, null, null, col, row, brickHeight, brickLength);
              brick.health = G.generateHealth("red");
              t4 = this._gameField;
              if (row >= t4.length)
                return H.ioore(t4, row);
              J.$indexSet$ax(t4[row], col, brick);
              C.JSNull_methods.add$1(t3, brick);
              ...
              ball = new G.Ball(null, null, ballSpeed, col, row, ballHeight, ballLength);
              t4 = this._gameField;
              if (row >= t4.length)
                return H.ioore(t4, row);
              J.$indexSet$ax(t4[row], col, ball);
              C.JSNull_methods.add$1(t2, ball);
            } else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "player") === 0) {
              t4 = new G.Player(playerSpeed, col, row, playerHeight, playerLength);
              this.player = t4;
              t5 = this._gameField;
              if (row >= t5.length)
                return H.ioore(t5, row);
              J.$indexSet$ax(t5[row], col, t4);
            }
            ++col;
          }
          ++row;
    ...
    Level_readLevel_closure: {
      "^": "Closure:1;$this",
      call$1: function(row) {
        return P.Iterable_Iterable$generate(this.$this._length, new G.Level_readLevel__closure(), null).toList$0(0);
      }
    },
    ...
    Player: {
      "^": "MoveableObject;moveSpeed,xPosition,yPosition,width,length"
    },
    View: {
      "^": "Object;warningoverlay,title,level,gameover,game,overlay,gameFields"
    }
  }], ["", "web/brickgameClient.dart",, X, {
    "^": "",
    main: [function() {
      return G.GameController$();
    }, "call$0", "brickgameClient__main$closure", 0, 0, 0]
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}];
